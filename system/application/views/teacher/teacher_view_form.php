 ...
 <?php  include('./system/application/views/header.php');?>
    ...
    <div class="col-md-10">
      ...
      <h2 ><span class="style boxshadow"> View Teacher </span> </h2>
              <div class="block">    
                        ...
                        Action <span class="caret"></span>
                                              ...
                                              <ul class="dropdown-menu dropdown-default pull-right" >
                                               <li> 
                                                ...
                                                <?php echo "<a href='teacher_edit/$row[id]'> <span class='glyphicon glyphicon-pencil ' aria-hidden='true'></span> Edit</a>"?>  
                         
                                        </li>
                                        <li> 
                                                <?php echo "<a href='teacher_delete/$row[id]' > <span class='glyphicon glyphicon-trash' aria-hidden='true'></span> Delete</a>"?>  
                                       
                                        </li>
                                          <li> 
                                                <?php echo "<a href='teacher_profile/$row[id]'> <span class='glyphicon glyphicon-user' aria-hidden='true'></span> Profile</a>"?>  
